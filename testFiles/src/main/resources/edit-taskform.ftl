<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("out_file");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid out_file");
							myInputs[j].focus();
							return false;
						}
		...
		<fieldset>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		<label for="name">out_file</label>
                            		<div class="div_texbox">
                              		<input name="out_file" type="text" class="textbox" id="out_file" value="" />
                            		</div>
